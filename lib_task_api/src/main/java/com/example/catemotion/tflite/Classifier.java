...
package com.example.catemotion.tflite;
...
public abstract class Classifier {
  ...
  /** The model type used for com.example.catemotion. */
  public enum Model {
    FLOAT_MOBILENET,
    QUANTIZED_MOBILENET,
    FLOAT_EFFICIENTNET,
  ...
  /** The runtime device type used for executing com.example.catemotion. */
  public enum Device {
    CPU,
    NNAPI,
    GPU
   ...
   * @param model The model to use for com.example.catemotion.
   * @param device The device to use for com.example.catemotion.
   * @param numThreads The number of threads to use for com.example.catemotion.
  ...
  /** Runs inference and returns the com.example.catemotion results. */
